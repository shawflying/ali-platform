...
const ResultExample = () => (
  <div className="result-example">
    <div className={sytle['sub-title']}  style={{color:"red"}}>支付成功</div>
    <Result
    ...
    />
    <WhiteSpace />
    <div className={sytle['sub-title']}>验证成功</div>
    <Result
    ...
    />
    <WhiteSpace />
    <div className={sytle['sub-title']}>支付失败</div>
    <Result
    ...
    />
    <WhiteSpace />
    <div className={sytle['sub-title']}>等待处理</div>
    <Result
    ...
    />
    <WhiteSpace />
    <div className={sytle['sub-title']}>操作失败</div>
    <Result
